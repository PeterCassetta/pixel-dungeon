...
import com.petercassetta.pdrebalanced.windows.WndError;
import com.petercassetta.pdrebalanced.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			float rowHeight = PDRebalanced.landscape() ? ROW_HEIGHT_L : ROW_HEIGHT_P;
