 ...
 */
package com.petercassetta.pdrebalanced.items.weapon;
...
import com.petercassetta.pdrebalanced.items.weapon.enchantments.*;
...
public class Weapon extends KindOfWeapon {
	...
	private static final String UNFAMILIARITY = "unfamiliarity";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( UNFAMILIARITY, hitsToKnow );
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if ((hitsToKnow = bundle.getInt( UNFAMILIARITY )) == 0) {
